...
class TM_Timeline_Elementor_Widget extends Elementor\Widget_Base {
	...
	public function get_shortcode( $name ) {
		...
		if ( ! isset( tm_timeline_elementor_compat()->shortcodes[ $this->get_name() ] ) ) {
			return;
		}

		$shortcode = wp_parse_args( tm_timeline_elementor_compat()->shortcodes[ $this->get_name() ], array(
			'title' => null,
	...
	public function get_name() {
		return Tm_Timeline::get_shortcode_tag();
	}
