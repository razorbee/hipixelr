...
function booked_mailer( $to, $subject, $message, $from_email = false, $from_name = false ){
	...
	if ( file_exists( get_stylesheet_directory() . '/booked/email-template.html' ) ):
		$template = file__get_contents( get_stylesheet_directory() . '/booked/email-template.html', true );
	elseif ( file_exists( get_template_directory() . '/booked/email-template.html' ) ):
		$template = file__get_contents( get_template_directory() . '/booked/email-template.html', true );
	else:
		$template = file__get_contents( untrailingslashit( BOOKED_PLUGIN_DIR ) . '/includes/email-templates/default.html', true );
	endif;
