...
class Hybrid_Endpoint
{
	...
	*/
	...
	{
		$output = file__get_contents( dirname(__FILE__) . "/resources/openid_policy.html" ); 
		print $output;
		die();
	}
	...
	*/
	public static function processOpenidXRDS()
	{
		...
		(
			...
			file__get_contents( dirname(__FILE__) . "/resources/openid_xrds.xml" )
		);
		print $output;
		die();
	}
	...
	*/
	public static function processOpenidRealm()
	{
		...
		(
			...
			file__get_contents( dirname(__FILE__) . "/resources/openid_realm.html" )
		); 
		print $output;
		die();
	}
