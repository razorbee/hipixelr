...
<article id="post-<?php the_ID(); ?>" <?php post_class( 'posts-list__item card' ); ?>>
	...
	<?php $blog_layout_type = get_theme_mod( 'blog_layout_type', frameme_theme()->customizer->get_default( 'blog_layout_type' ) ); ?>
	...
	<div class="posts-list__right-col">
		<?php
			if ( 'default' !== $blog_layout_type || frameme_check_for_small_image_default_listing() ) :
				get_template_part( 'template-parts/post/post-meta/content-meta-date' );
			endif;
		?>
