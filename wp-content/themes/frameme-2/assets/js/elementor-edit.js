( function( $, data ) {
	...
	var framemeElementor = {

		init: function() {

			if ( ! _.isEmpty( data.widgets ) ) {
				_.each( data.widgets, framemeElementor.widgetsWalker );
			}

		},

		widgetsWalker: function( widget ) {
			elementor.hooks.addAction( 'panel/open_editor/widget/wp-widget-' + widget, framemeElementor.initCb );
		},
	...
	framemeElementor.init();

}( jQuery, window.framemeEditData ) );
