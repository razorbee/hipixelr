...
if ( ! class_exists( 'FrameMe_Widget_Area' ) ) {

	/**
	 * Class FrameMe_Widget_Area.
	 */
	class FrameMe_Widget_Area {
		...
		function __construct() {
			...
			add_action( 'frameme_render_widget_area', array( $this, 'render' ) );
		}
		...
		public function render( $area_id ) {
			...
			$area_id        = apply_filters( 'frameme_rendering_current_widget_area', $area_id );
			...
			$classes = apply_filters( 'frameme_widget_area_classes', $classes, $area_id );
	 ...
	 * @return object
	 */
	function frameme_widget_area() {
		return FrameMe_Widget_Area::get_instance();
	}
